...
RSpec.describe(Logging) do
  ...
  describe '#log_info' do
    it 'logs info with class and method name' do
      expect(logger).to receive(:info).with(/DummyClass#: info message/)
      dummy.test_info
    end
  end
  ...
  describe '#log_debug' do
    it 'logs debug with class and method name' do
      expect(logger).to receive(:debug).with(/DummyClass#: debug message/)
      dummy.test_debug
    end
  end
  ...
  describe '#log_error' do
    it 'logs error with class and method name' do
      expect(logger).to receive(:error).with(/DummyClass#: error message/)
      dummy.test_error
    end
  end
end
